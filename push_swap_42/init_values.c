...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/05 11:10:24 by user42            #+#    #+#             */
/*   Updated: 2021/04/05 11:10:25 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static void	sort_set(t_data *data)
{
	int	i;
	...
	sort(data, data->num_a, data->sort);
	if ((float)(data->num_a % 2) == 0.0)
		data->pivot_index = (data->num_a / 2) - 1;
	else
		data->pivot_index = data->num_a / 2;
	data->pivot = data->sort[data->pivot_index];
}
